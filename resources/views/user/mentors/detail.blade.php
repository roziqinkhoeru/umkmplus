                    ...
                    <div class="col-lg-7">
                        <div class="d-sm-flex mb-30 mb-lg-0">
                            <div class="mentor-image-wrapper">
                                <figure class="mb-0 mentor-image-circle"><img
                                        src="{{ asset('assets/img/dummy/mentor-1.jpg') }}" alt="nama-mentor"></figure>
                            </div>
                            <div class="mentor-content-wrapper">
                                <h2>Verdian Galang Pratama Arhan</h2>
                                <h6>Professional Branding</h6>
                                <div class="d-flex align-items-center mb-10">
                                    <i class="fa-solid fa-circle-user me-2 text-xl text-tp-theme-1"
                                        style="transform: translateY(-2px)"></i>
                                    <p class="mb-0 me-4">200 Students</p>
                                    <i class="fa-regular fa-clapperboard-play me-2 text-xl text-tp-theme-1"></i>
                                    <p class="mb-0">4 Kelas</p>
                                </div>
                                <p class="mb-0 fst-italic text-xs text-muted">*Mentor sejak 23 Juni 2022</p>
                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="card rounded-2-5">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-0">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Mollitia veniam
                                    atque
                                    eius odio tempora quibusdam facilis alias ipsa expedita, at hic cupiditate assumenda
                                    accusamus reiciendis quia excepturi, possimus minima consequuntur!</p>
                            </div>
                        </div>
                    </div>
                </div>
