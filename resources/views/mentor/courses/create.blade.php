                                    ...
                                    <div class="col-lg-6 col-md-9 col-sm-8">
                                        <div class="input-file input-file-image">
                                            <img class="img-upload-preview" width="240" src="http://placehold.it/240x240"
                                                alt="course-thumbnail" id="imagePreview">
    ...
    @section('script')
        ...
        <script>
            ...
            window.onload = function() {
                ...
                var storedImage = localStorage.getItem('imageThumbnailCourse');
            ...
            function previewImage(event) {
                ...
                reader.onload = function(e) {
                    ...
                    localStorage.setItem('imageThumbnailCourse', e.target.result);
                };
