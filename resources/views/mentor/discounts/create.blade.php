                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Form Tambah Diskon</div>
                            <div class="card-category">
                                Form ini digunakan untuk menambah data diskon
                            </div>
                        </div>
                        <form id="formAddDiscount" action="{{ url('/mentor/discount') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                {{-- Kode --}}
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="code" name="code"
                                            value="{{ old('code') }}" required oninput="convertToUppercase()"
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" name="discount" class="form-control" id="discount"
                                                placeholder="Masukkan Nominal Diskon" value="{{ old('discount') }}"
                                                required>
